# ISOLATED_PHP_VERSION=81
server {
    listen 127.0.0.1:80;
    #listen 127.0.0.1:80; # valet loopback
    server_name admin.testing.com www.admin.testing.com *.admin.testing.com;
...
server {
    ...
    ssl_certificate "/Users/Meilunzhi/.config/valet/Certificates/admin.testing.com.crt";
    ssl_certificate_key "/Users/Meilunzhi/.config/valet/Certificates/admin.testing.com.key";
    ...
    location ~ [^/]\.php(/|$) {
        ...
        fastcgi_pass "unix:/Users/Meilunzhi/.config/valet/valet81.sock";
