server {
    ...
    server_name dcat-admin.testing.com www.dcat-admin.testing.com *.dcat-admin.testing.com;
...
server {
    ...
    ssl_certificate "/Users/Meilunzhi/.config/valet/Certificates/dcat-admin.testing.com.crt";
    ssl_certificate_key "/Users/Meilunzhi/.config/valet/Certificates/dcat-admin.testing.com.key";
    ...
    location ~ [^/]\.php(/|$) {
        ...
        fastcgi_pass "unix:/Users/Meilunzhi/.config/valet/valet.sock";
